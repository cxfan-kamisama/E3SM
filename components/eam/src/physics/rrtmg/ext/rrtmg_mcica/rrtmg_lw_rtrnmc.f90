...
!
      module rrtmg_lw_rtrnmc
            ...
            !*************************************************************************
            ! U-MICH team add (subroutines rtr2function, TwsFunctionIR, and TDMA)-->
                  ...
                  ! Res., 94(D13), 16287?~@~S16301, doi:10.1029/JD094iD13p16287.
                  !+
                  ! History
                  ...
                  !-------------------------------------------------
                        subroutine rtr2function(nlayers, istart, iend, iout, pz, semiss, ncbands, &
                           cldfrac, taucloud, ssacloud, asmcloud, &
                  ...
                  ! Clouds
                  ! U-MICH team Dec.18, 2019 note: make the dimension of cloud variables be consisnt with CESM
                  integer, intent(in) :: ncbands         ! number of cloud spectral bands
                  ...
                  real(kind=r8), intent(in) :: ssacloud(:,:)      ! layer cloud single-scattering albedo
                                                   !    Dimensions: (ngptlw,nlayers)
                  real(kind=r8), intent(in) :: asmcloud(:,:)      ! layer cloud expansion coefficients of phase function
                  ...
                  !    asmcloud                     ! layer cloud expansion coefficients of phase function
                  !    semiss                       ! surface emissivities for each band
                  !    bpade                        ! 1/(pade constant)
                  !    tau_tbl                      ! clear sky optical depth look-up table
                  !    exp_tbl                      ! exponential look-up table for transmittance
                  ...
                  !U-MICH team cancel 2017-02-22            if (taut(lay,ig) .lt. 0.0_r8) then
                  !U-MICH team cancel 2017-02-22               taurevcld(nlayers-lay+1) = taucloud(lay,iband)
                  !U-MICH team cancel 2017-02-22            else
                  !U-MICH team cancel 2017-02-22               taurevcld(nlayers-lay+1) = taut(lay,ig) + taucloud(lay,iband)
                  !U-MICH team cancel 2017-02-22            endif
                  !U-MICH team cancel 2017-02-22            scatcld = ssacloud(lay,iband) * taucloud(lay,iband)
                  !U-MICH team cancel 2017-02-22            asyrevcld(nlayers-lay+1) = asmcloud(1,lay,iband)
            
                  !>>> U-MICH team add 2017-02-22, note that taucloud dimension is
                  ...
                  asyrevcld(nlayers-lay+1) = asmcloud(ig,lay)
                  !<<< U-MICH team add 2017-02-22 <<<
            
                  if (taurevcld(nlayers-lay+1) .ne. 0.0_r8) &
                  ...
                  do lev = 0, nlayers
                  if (fluxdncld(lev) < 0.0_r8) fluxdncld(lev) = 0.0_r8
                  if (fluxupcld(lev) < 0.0_r8) fluxupcld(lev) = 0.0_r8
                  enddo
                  ...
                  ! Set unphysical values to 0.0
                  do lev = 0, nlayers
                  if (fluxdnclr(lev) < 0.0_r8) fluxdnclr(lev) = 0.0_r8
                  if (fluxupclr(lev) < 0.0_r8) fluxupclr(lev) = 0.0_r8
                  enddo
                  ...
                  ! back substitution
                  !U-MICH team comment 2017-11-26, do i = N, 1, -1
                  !U-MICH team comment 2017-11-26   X(i) = P(i) * X(i+1) + Q(i)
                  !U-MICH team comment 2017-11-26 enddo      
            
                  !>>> U-MICH team add 2017-11-26, to avoid use X(N+1) which could be
                  ...
                  X(i) = P(i) * X(i+1) + Q(i)
                  enddo
                  !<<< U-MICH team add 2017-11-26 <<<
            
                  end subroutine TDMA
            ! <--- END of adding subroutines by U-MICH.
